...
//                else
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ed5=editTextQualification.getText().toString();
                ...
                if (size!=11){
                    ...
                    address = "http://192.168.8.101/ocs.ebs-agro-portal.com/include/insert.php?Name=" + editTextName.getText().toString()
                            ...
                            + "&Mobile=" + editTextMobile.getText().toString() + "".toString();

                    getData();
                    //Toast.makeText(context, editTextAge.getText().toString(), Toast.LENGTH_LONG).show();
