...
import java.net.URLEncoder;
 ...
 public class BworkerUser extends AsyncTask<String,Void,String>
{
    Context context;
    AlertDialog alertDialog;
    URLs urLs;
    BworkerUser (Context ctx)
    {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        {
            String login_url = urLs.BASE_URL+"userlogin.php";
            try {
    ...
    protected void onPostExecute(String result) {
        ...
        else
        {
            ...
            editor.putInt("PatientId", result1);
            editor.apply();
            int Patid =pref.getInt("PatientId", 0);

            Intent i = new Intent(this.context,UserDesk.class);
            context.startActivity(i);
            String tmpStr10 = String.valueOf(Patid);
